...
def blinking():
    ...
    if event.type == pygame.MOUSEMOTION:
        ...
        if pos[0] >= 50 and pos[0] <= 700 and pos[1] >= 550 and pos[1] <= 650:
            ...
            imagebs = pygame.draw.rect(screen, (255,25,255, 70), [50 + 50 * columny, 550 + 50 * rowx, 50,50], 8)
            return imagebs
...
while not done:
    ...
    rect1 = pygame.draw.rect(screen, YELLOW, [200, 200, 50*len(word), 100], 5)
    ...
    screen.blit(draw_text(str(word.upper())), [220, 220])
